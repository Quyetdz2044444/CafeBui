        ...
        btnSua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(hoTenMoi) || TextUtils.isEmpty(soDienThoaiMoi) || TextUtils.isEmpty(diaChiMoi)) {
                    Toast.makeText(XacNhanDatHang_TrangChu.this, "Sửa chưa thành công, hãy điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                    return;
                } else if (!soDienThoaiMoi.matches("\\d+")) {
                    Toast.makeText(XacNhanDatHang_TrangChu.this, "Số điện thoại chỉ được chứa số", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    ...
                    Toast.makeText(XacNhanDatHang_TrangChu.this, "Cập nhật xong", Toast.LENGTH_SHORT).show();
                    alertDialog.dismiss();
                }
            }
        });
